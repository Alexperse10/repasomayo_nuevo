...
public class PalabrasDicc {

    public static HashMap<String, String> cargarDiccionario() {
        ...
        diccionario.put("estacion","station");
        ...
        diccionario.put("mañana_tiempo","tomorrow");
